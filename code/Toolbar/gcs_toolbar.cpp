    ...
    ui(new Ui::GcsToolbar)
{
    ...
    btnMapView->setIcon(QIcon(":/gcs_tb/icons/map.png"));
    btnUavView = new QToolButton(this);
    btnUavView->setIcon(QIcon(":/gcs_tb/icons/uav.png"));
    btnUgvView = new QToolButton(this);
    btnUgvView->setIcon(QIcon(":/gcs_tb/icons/ugv.png"));
    btnWaypointContext = new QToolButton(this);
    btnWaypointContext->setIcon(QIcon(":/gcs_tb/icons/waypoint.png"));
    btnZoningContext = new QToolButton(this);
    btnZoningContext->setIcon(QIcon(":/gcs_tb/icons/zone.png"));
    btnPayloadContext = new QToolButton(this);
    btnPayloadContext->setIcon(QIcon(":/gcs_tb/icons/payload.png"));
    btnSettings = new QToolButton(this);
    btnSettings->setIcon(QIcon(":/gcs_tb/icons/settings.png"));

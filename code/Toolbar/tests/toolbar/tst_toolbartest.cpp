...
{
    mtb = new GcsToolbar;
    qRegisterMetaType<GcsToolbar::Vehicle>("GcsToolbar::Vehicle");
}
...
{
    QToolButton *btnMapView = mtb->getBtnMapView();
...
{
    QToolButton *btn = mtb->getBtnPayloadContext();
...
{
    QToolButton *btn = mtb->getBtnWaypointContext();
...
{
    QToolButton *btn = mtb->getBtnZoningContext();
...
{
    QToolButton *btn = mtb->getBtnSettings();

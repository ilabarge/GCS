...
public:
    ...
    {
        actionMap_View->setText(QApplication::translate("GcsToolbar", "Map View", Q_NULLPTR));
        actionPayload->setText(QApplication::translate("GcsToolbar", "Deploy Payload", Q_NULLPTR));
        actionZoning->setText(QApplication::translate("GcsToolbar", "Edit Zones", Q_NULLPTR));
        actionWaypoints->setText(QApplication::translate("GcsToolbar", "Edit Waypoints", Q_NULLPTR));
        actionSettings->setText(QApplication::translate("GcsToolbar", "Settings", Q_NULLPTR));
        actionCPP_UAV->setText(QApplication::translate("GcsToolbar", "CPP UAV", Q_NULLPTR));
        actionSLO_UAV->setText(QApplication::translate("GcsToolbar", "SLO UAV", Q_NULLPTR));
        actionCPP_UGV->setText(QApplication::translate("GcsToolbar", "CPP UGV", Q_NULLPTR));
        actionSLO_UGV->setText(QApplication::translate("GcsToolbar", "SLO UGV", Q_NULLPTR));
        actionCPP_UAV2->setText(QApplication::translate("GcsToolbar", "CPP UAV2", Q_NULLPTR));
        menuViews->setTitle(QApplication::translate("GcsToolbar", "Views", Q_NULLPTR));
        menuUAV_View->setTitle(QApplication::translate("GcsToolbar", "UAV View", Q_NULLPTR));
        menuUGV_View->setTitle(QApplication::translate("GcsToolbar", "UGV View", Q_NULLPTR));
        menuActions->setTitle(QApplication::translate("GcsToolbar", "Actions", Q_NULLPTR));
        menuSettings->setTitle(QApplication::translate("GcsToolbar", "Settings", Q_NULLPTR));
        menu_File->setTitle(QApplication::translate("GcsToolbar", "&File", Q_NULLPTR));
        Q_UNUSED(GcsToolbar);
    } // retranslateUi

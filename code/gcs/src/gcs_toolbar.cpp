    ...
    ui(new Ui::GcsToolbar)
{
    ...
    btnMapView->setIcon(QIcon(":/gcs_mtb_map_icon.png"));
    btnUavView = new QToolButton(this);
    btnUavView->setIcon(QIcon(":/gcs_mtb_uav_icon.png"));
    btnUgvView = new QToolButton(this);
    btnUgvView->setIcon(QIcon(":/gcs_mtb_ugv_icon.png"));
    btnWaypointContext = new QToolButton(this);
    btnWaypointContext->setIcon(QIcon("://gcs_mtb_waypoint_icon.png"));
    btnZoningContext = new QToolButton(this);
    btnZoningContext->setIcon(QIcon(":/gcs_mtb_zone_icon.png"));
    btnPayloadContext = new QToolButton(this);
    btnPayloadContext->setIcon(QIcon(":/gcs_mtb_payload_icon.png"));
    btnSettings = new QToolButton(this);
    btnSettings->setIcon(QIcon(":/gcs_mtb_settings_icon.png"));
